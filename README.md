...
This demo uses Apache CXF with Spring Boot to create a simple SOAP web service.

The demo uses Spring Boot to configure a simple application that includes a CXF JAXWS endpoint.
...
You can then use the host report to access the service:
    ...
    https://example1-myproject.example.com /service/SapService?wsdl
